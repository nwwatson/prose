...
ActiveRecord::Schema[8.1].define(version: 2026_01_02_042115) do
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.index ["publication_id", "published_at"], name: "index_posts_on_publication_id_and_published_at"
    t.index ["publication_id", "slug"], name: "index_posts_on_publication_id_and_slug", unique: true
    t.index ["publication_id", "status"], name: "index_posts_on_publication_id_and_status"
  ...
  add_foreign_key "posts", "publications", on_delete: :cascade
